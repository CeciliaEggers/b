    ...
    return (
      ...
      <div>
        ...
        <div className="cat-container">
         ...
         <Link to={{pathname:"/productos/todo", state:{categoria: "todo"}}}style={{ textDecoration: 'none' }}>
            <div className="cat">
          ...
          <Link to={{pathname:"/productos/verdura", state:{categoria: "verdura"}}}style={{ textDecoration: 'none' }}>
            <div className="cat">
                <img alt="imagenVerdura" src="https://farm9.staticflickr.com/8459/8049186415_679c90977d.jpg"></img>
                <h4>Verduras</h4>
            </div>
          </Link>
          <Link to={{pathname:"/productos/fruta", state:{categoria: "fruta"}}}style={{ textDecoration: 'none' }}>
            <div className="cat">
